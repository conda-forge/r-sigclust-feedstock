...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-sigclust-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-sigclust-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-sigclust-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-sigclust-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-sigclust-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-sigclust-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-sigclust/badges/version.svg)](https://anaconda.org/conda-forge/r-sigclust)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-sigclust/badges/downloads.svg)](https://anaconda.org/conda-forge/r-sigclust)
